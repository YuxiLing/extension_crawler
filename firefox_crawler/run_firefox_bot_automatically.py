...
def export_csv(filter_cleaned_data,csv_file):
    ...
    csv_columns = ['platform', 'id', 'download_link','key','name', 'rating', 'user_numbers', 'creator', 'last_updated', 'reviews']
...
while True:
    ...
    # for i in range(8):
    #     time.sleep(3600)
    #     print("Slept one hour, now is ",datetime.datetime.now(),file=open("firefox_log.txt","a"))
    ...
    print("Getting source code and finding missed extensions....", file=open("firefox_log.txt", "a"))
