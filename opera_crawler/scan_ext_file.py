...
def scanByDir(src_folder, dst_folder, output_file, move):
    ...
    print("updated scan_result_id file", file=open('opera_log.txt', 'a'))
...
def updateMaliciousList(id,malicious_folder,count):
    ...
    raw_path='./malicious_ext_crawler/data/full_list/opera_ext_data_[%s]FILTER_KEYWORDS.json' % count
...
def handleOriginResult(id, res_json, src_folder, malicious_folder,count):
    ...
    for engine in engine_list:
        ...
        if res != None:
            ...
            print("in extension:", id, "find bug in:", engine, "output:", res,file=open('./opera_log.txt','a'))
